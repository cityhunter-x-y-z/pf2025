...
// Hero images
const imgA1 = "https://www.figma.com/api/mcp/asset/718e3d9f-dfb2-47ca-ae54-8d53152281c6";
const imgJobOpeningForm = "https://www.figma.com/api/mcp/asset/5f8c6fd3-2f1d-4235-8d8c-a8e63b83f7bc";
const imgContentContainer = "https://www.figma.com/api/mcp/asset/f8312bda-0bfb-46c0-ba1e-45bae74a5635";
          ...
          <div className="max-w-[760px] mx-auto flex flex-col gap-[72px]">
            ...
            >
              ...
              <div className="relative w-full">
                {/* Shadow */}
                <div className="absolute left-[31.53px] top-[247px] w-[696.936px] h-[151px] bg-white opacity-30 shadow-[0px_0px_250px_22px_rgba(0,0,0,0.25)]" />

                {/* Main Container */}
                <div className="relative border-8 border-[rgba(0,0,0,0.04)] rounded-xl h-[447px] w-full overflow-hidden" style={{ background: 'linear-gradient(90deg, rgba(128, 161, 127, 0.25) 0%, rgba(128, 161, 127, 0.25) 100%), linear-gradient(90deg, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 1) 100%)' }}>
                  {/* Layered Images */}
                  <div className="absolute left-[50px] top-[37.62px] w-[693px] flex items-end">
                    <img src={imgA1} alt="Component layer 1" className="absolute w-[681.651px] h-[405.373px] object-cover" />
                    <img src={imgJobOpeningForm} alt="Component layer 2" className="absolute w-[689.099px] h-[346.5px] object-cover" />
                    <img src={imgContentContainer} alt="Component layer 3" className="absolute w-[693px] h-[257.126px] object-cover" />
                  </div>
            ...
            >
              ...
              <div className="flex flex-col gap-16 w-full">
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <p className="font-trispace text-base leading-[1.34em] text-[#90A2C3]" style={{ letterSpacing: '-2%' }}>
                    Scaled - 0.75:1
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full">
                  ...
                  <div className="w-full aspect-[2820/180]">
                    <img src={imgTopbarPreAuth} alt="Pre-Authentication navigation state" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full">
                  ...
                  <div className="w-full aspect-[2820/180]">
                    <img src={imgTopbarPostAuth} alt="Post-Authentication navigation state" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full">
                  ...
                  <div className="w-full aspect-[2820/180]">
                    <img src={imgTopbarSearch} alt="Search active navigation state" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex gap-10 items-center w-full">
                {/* Default State */}
                <div className="flex flex-col gap-4 w-[187.5px]">
                  <p className="font-trispace text-base leading-[1.34em] text-text-quaternary" style={{ letterSpacing: '-2%' }}>
                    Default
                  </p>
                  <div className="h-[36px] w-[188px]">
                    <img src={imgSearchDefault} alt="Search box default state" className="w-full h-full object-cover" />
                  </div>
                </div>

                {/* Focused State */}
                <div className="flex flex-col gap-4 w-[469px]">
                  <p className="font-trispace text-base leading-[1.34em] text-text-quaternary" style={{ letterSpacing: '-2%' }}>
                    Focused
                  </p>
                  <div className="h-[43px] w-[469px]">
                    <img src={imgSearchFocused} alt="Search box focused state" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 w-full">
                <p className="font-trispace text-base leading-[1.34em] text-text-quaternary h-[36px]" style={{ letterSpacing: '-2%' }}>
                  Interaction
                </p>
                <div className="h-[250px] w-[505px]">
                  <img src={imgSearchInteraction} alt="Search box interaction with suggestions" className="w-full h-full object-cover" />
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="flex flex-col gap-8 w-full">
                ...
                <div className="flex gap-10 items-center w-full">
                  ...
                  <div className="flex flex-col gap-3 w-[110px]">
                    ...
                    <div className="w-[90px] h-[90px]">
                      <img src={imgNotificationDefault} alt="Notification bell default state" className="w-full h-full object-cover" />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 w-[110px]">
                    ...
                    <div className="w-[90px] h-[90px]">
                      <img src={imgNotificationHovered} alt="Notification bell hovered state" className="w-full h-full object-cover" />
                    </div>
                  </div>

                  {/* Active State */}
                  <div className="flex flex-col gap-3 w-[101px]">
                    <p className="font-trispace text-base leading-[1.34em] text-text-quaternary" style={{ letterSpacing: '-2%' }}>
                      Active
                    </p>
                    <div className="w-[90px] h-[90px]">
                      <img src={imgNotificationActive} alt="Notification bell active state" className="w-full h-full object-cover" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full">
                  ...
                  <div className="w-[90px] h-[90px]">
                    <img src={imgNotificationAction} alt="Notification bell action state" className="w-full h-full object-cover" />
                  </div>
                  <div className="w-[545px] h-[613px]">
                    <img src={imgNotificationPanel} alt="Notification panel dropdown" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="flex gap-10 items-start">
                ...
                <div className="flex flex-col gap-3 w-[110px]">
                  ...
                  <div className="w-[90px] h-[90px]">
                    <img src={imgMegaMenuDefault} alt="9 dot mega menu default state" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 w-[110px]">
                  ...
                  <div className="w-[106px] h-[110px]">
                    <img src={imgMegaMenuFocus} alt="9 dot mega menu focus state" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="flex flex-col gap-16 w-full">
                ...
                <div className="flex flex-col gap-6 w-full">
                  <h3 className="font-['Space_Mono'] font-bold text-lg leading-[1.36em] text-text-quaternary" style={{ letterSpacing: '-1%' }}>
                    Dashboard for Job Openings
                  </h3>
                  <div className="w-full aspect-[2868/1564]">
                    <img src={imgJobOpeningsDashboard} alt="Dashboard showing job openings with filters and application cards" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full">
                  ...
                  <div className="w-full aspect-[2868/2030]">
                    <img src={imgOngoingApplicationDashboard} alt="Dashboard showing ongoing applications with detailed progress tracking" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </motion.section>
            ...
            >
              ...
              {/* Default State */}
              <div className="flex flex-col gap-6 w-[515px]">
                <p className="font-trispace text-base leading-[1.34em] text-text-quaternary" style={{ letterSpacing: '-2%' }}>
                  Default
                </p>
                <div className="w-[515px] h-[115px]">
                  <img src={imgProgressDefault} alt="Application progress card showing Site Engineer position in default collapsed state" className="w-full h-full object-cover" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 w-[515px]">
                ...
                <div className="w-[515px] h-[213px]">
                  <img src={imgProgressExpanded} alt="Application progress card showing Architect position with expanded details and conversion probability" className="w-full h-full object-cover" />
                </div>
              </div>

              {/* Conversion Probability Explanation */}
              <div className="flex flex-col gap-2 w-full">
                <h3 className="font-['Space_Mono'] font-bold text-lg leading-[1.36em] text-ui-gray" style={{ letterSpacing: '-1%' }}>
                ...
                <div className="font-trispace text-base leading-[1.34em] text-text-quaternary" style={{ letterSpacing: '-2%' }}>
            ...
            >
              ...
              <div className="flex gap-2 items-center w-full">
                <div className="flex flex-col gap-2.5 items-center w-[100px]">
                ...
                <p className="flex-1 font-trispace text-base leading-[1.34em] text-text-quaternary" style={{ letterSpacing: '-2%' }}>
            ...
            <motion.section
              ...
              className="flex flex-col gap-[53px] w-full"
            >
              {/* Header */}
              <div className="flex flex-col gap-4 w-full">
                <h2 className="font-['Space_Mono'] font-bold text-[32px] leading-[1.36em] text-ui-gray" style={{ letterSpacing: '-2%' }}>
              ...
              <div className="flex flex-col gap-16 w-full">
                ...
                <div className="flex flex-col gap-3 w-full">
                  ...
                  <div className="w-full aspect-[2838/831]">
                    <img src={imgRecruiterDash} alt="Recruiter dashboard showing job listings with application counts and filters" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-8 w-full">
                  ...
                  <div className="flex flex-col gap-8 w-full">
                    ...
                    <div className="w-[590px] h-[65.318px]">
                      <img src={imgJobItemBreakdown} alt="Job list item component breakdown" className="w-full h-full object-cover" />
                    </div>
                  </div>

                  {/* Application Badge Explanation */}
                  <div className="flex gap-3 items-center w-full h-[57px]">
                    <div className="flex items-start w-[150px] py-1">
                      <div className="w-[45px] h-[45px]">
                        <img src={imgApplicationBadge} alt="Application count badge showing 99+" className="w-full h-full object-cover" />
                      </div>
                    </div>
                    <div className="font-['Roboto'] text-base text-text-quaternary" style={{ letterSpacing: '-0.32px' }}>
                  ...
                  <div className="flex gap-3 items-center w-full">
                    <div className="w-[150px] h-[51px]">
                      <img src={imgJobTexts} alt="Job role and location text fields" className="w-full h-full object-cover" />
                    </div>
                    <div className="flex gap-3 items-center">
                      <p className="font-['Roboto'] text-base text-text-quaternary" style={{ letterSpacing: '-0.32px' }}>
                  ...
                  <div className="flex gap-3 items-center w-full h-6">
                    <div className="w-[150px] h-6">
                      <img src={imgEnvelopeIcon} alt="Envelope icon with notification badge" className="w-full h-full object-cover" />
                    </div>
                    <p className="font-['Roboto'] text-base text-text-quaternary" style={{ letterSpacing: '-0.32px' }}>
            ...
            >
              ...
              <div className="w-full aspect-[2898/1902]">
                <img src={imgJobCardDetails} alt="Detailed view of job card showing candidate applications with filters and status options" className="w-full h-full object-cover" />
              </div>

              {/* Button States */}
              <div className="w-full aspect-[3000/744]">
                <img src={imgButtonStates} alt="Mark As button states showing Fit, Unfit, and Onhold options with dropdown menus" className="w-full h-full object-cover" />
              </div>

              {/* Reset Note */}
              <div className="flex flex-col gap-8 h-10 items-start w-full">
                <div className="flex flex-1 flex-col justify-center items-center w-full">
                  <p className="font-['Space_Mono'] font-bold text-lg leading-[1.36em] text-text-quaternary text-center" style={{ letterSpacing: '-1%' }}>
            ...
            >
              ...
              <div className="w-full aspect-[2058/1452]">
                <img src={imgBulkSelection} alt="Bulk candidate selection interface with checkboxes and status filters" className="w-full h-full object-cover" />
              </div>

              {/* Bulk Action Flow */}
              <div className="w-full aspect-[2805/1932]">
                <img src={imgBulkActionFlow} alt="Bulk action flow showing candidate selection and routing path" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="w-full aspect-[2058/1517]">
                <img src={imgBulkCompose} alt="Compose interface for bulk candidate communication with rich text editor" className="w-full h-full object-cover" />
              </div>
            </motion.section>
            ...
            <motion.section
              ...
              className="flex flex-col items-start pb-[54px] w-full"
            >
              {/* Job Application Dashboard for Candidate */}
              <div className="flex flex-col h-[169px] items-center justify-center mb-[-54px] w-full relative">
                <img src={imgContentBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
                <div className="flex flex-col gap-3 px-6 w-full relative z-10">
                  <h3 className="font-['Space_Mono'] font-bold text-[32px] leading-[1.36em] text-ui-gray" style={{ letterSpacing: '-2%' }}>
                    Job Application Dashboard for Candidate
                  </h3>
                </div>
              </div>
              ...
              {/* Configuration Page */}
              <div className="flex flex-col h-[169px] items-center justify-center mb-[-54px] w-full relative shadow-[0px_-8px_8px_0px_rgba(175,175,175,0.1)]">
                <img src={imgContentBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
                <div className="flex flex-col gap-3 px-6 w-full relative z-10">
                  <h3 className="font-['Space_Mono'] font-bold text-[32px] leading-[1.36em] text-ui-gray" style={{ letterSpacing: '-2%' }}>
                    Configuration Page
              ...
              <div className="flex flex-col h-[169px] items-center justify-center mb-[-54px] w-full relative shadow-[0px_-8px_8px_0px_rgba(175,175,175,0.1)]">
                ...
                <div className="flex flex-col gap-3 px-6 w-full relative z-10">
                  ...
                  <p className="font-['Roboto'] text-base leading-6 text-text-quaternary" style={{ letterSpacing: '-2%' }}>
                    Repetitive elements converted as components which infact is the created by using multiple 'molecules' and 'organisms' of atomic design structure.  Perplexity please generate some text content for here, adhere to the context
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col h-[169px] items-center justify-center mb-[-54px] w-full relative shadow-[0px_-8px_8px_0px_rgba(175,175,175,0.1)]">
                <img src={imgHeaderBg1} alt="" className="absolute inset-0 w-full h-full object-cover" />
                <div className="flex flex-col gap-3 px-6 w-full relative z-10">
                  <h3 className="font-['Space_Mono'] font-bold text-[32px] leading-[1.36em] text-ui-gray" style={{ letterSpacing: '-2%' }}>
                    Organization Profile Page
                  </h3>
              ...
              {/* Ellipsis Section */}
              <div className="flex flex-col h-[169px] items-center justify-center mb-[-54px] w-full relative shadow-[0px_-8px_8px_0px_rgba(175,175,175,0.1)]">
                <img src={imgHeaderBg2} alt="" className="absolute inset-0 w-full h-full object-cover" />
                <div className="flex flex-col gap-3 px-8 w-full relative z-10">
                  <p className="font-['Roboto_Slab'] font-medium text-[24px] leading-normal text-[#111111]" style={{ letterSpacing: '-0.48px' }}>
                    •••
                  </p>
                  <p className="font-['Roboto'] text-base leading-6 text-text-quaternary" style={{ letterSpacing: '-0.32px' }}>
                    •••
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#FEE4E2] flex flex-col gap-6 p-6 rounded-[24px] w-full mb-[-54px] relative shadow-[0px_-8px_8px_0px_rgba(175,175,175,0.1)]">
                <div className="flex gap-6 items-start w-full">
                  <div className="bg-white border-4 border-[rgba(219,137,83,0.19)] rounded-xl w-[192px] shrink-0 overflow-hidden">
                    <div className="flex flex-col h-full items-start w-[192px]">
                      <div className="flex-1 w-full">
                        <img src={imgGazeboThumbnail} alt="Gazebo Design System thumbnail" className="w-full h-full object-cover" />
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2 flex-1">
                    <h3 className="font-['Space_Mono'] font-bold text-lg leading-[1.36em] text-[#111111]" style={{ letterSpacing: '-1%' }}>
                      All Components DS
                    </h3>
                    <p className="font-trispace text-base leading-[1.34em] text-[#565C6F]" style={{ letterSpacing: '-2%' }}>
                    ...
                    <div className="flex gap-2.5 items-center">
                      <a
                        ...
                        className="font-['Roboto'] font-medium text-base leading-normal text-[#4A4AFC] underline cursor-pointer"
                        style={{ letterSpacing: '-0.32px', textUnderlinePosition: 'from-font' }}
                      >
                        Visit the File
                      </a>
                      <p className="font-['Inter'] font-medium text-base leading-normal text-[#4A4AFC]" style={{ letterSpacing: '-0.8px' }}>
                        →
                      </p>
                    </div>
                  </div>
